    ...
    * connects to tty device
    ...
    def __runInitSequence__(self, **kwargs):
        ...
        self.aboutArray.append(
            [
                ...
                "Installed" if self.NRF.ready else "Not Installed",
            ]
        )
    ...
    def read_bulk_flash(self, page, numbytes):
        ...
        **Arguments**
        ...
        if numbytes % 2:
            bytes_to_read += (
                1  # bytes+1 . stuff is stored as integers (byte+byte) in the hardware
            )
    ...
    def write_bulk_flash(self, location, data):
        ...
        **Arguments**
        ...
        self.H.__sendByte__(
            CP.WRITE_BULK_FLASH
        )  # indicate a flash write coming through
        ...
        if tmp != data:
            raise Exception("Verification by readback failed")
